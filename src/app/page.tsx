...
/**
 * Пауза между запросами к WB: лимит «1 запрос/мин» + запас. Страницы теперь
 * по 20k строк (тяжёлые 100k-страницы WB отбивает), поэтому длинных
 * «остываний» не нужно; при повторных отказах пауза всё же нарастает.
 */
const WB_WAIT_BASE_MS = 65000;
