...
export const BARCODE_HEADER = "Баркод";

/** Запасной индекс столбца с баркодом в отчёте WB: колонка I = 9-я (индекс 8). */
export const BARCODE_REPORT_COL_INDEX = 8;
...
export interface ParsedReport {
  ...
  headers: string[];
  /** Фактическое имя столбца с баркодом в этом отчете. */
